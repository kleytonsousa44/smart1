...
const downloadMedia = (msg) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const mineType = ((_b = msg.message) === null || _b === void 0 ? void 0 : _b.imageMessage) ||
        ((_c = msg.message) === null || _c === void 0 ? void 0 : _c.audioMessage) ||
        ((_d = msg.message) === null || _d === void 0 ? void 0 : _d.videoMessage) ||
        ((_e = msg.message) === null || _e === void 0 ? void 0 : _e.stickerMessage) ||
        ((_f = msg.message) === null || _f === void 0 ? void 0 : _f.documentMessage) ||
        ((_k = (_j = (_h = (_g = msg.message) === null || _g === void 0 ? void 0 : _g.extendedTextMessage) === null || _h === void 0 ? void 0 : _h.contextInfo) === null || _j === void 0 ? void 0 : _j.quotedMessage) === null || _k === void 0 ? void 0 : _k.imageMessage);
    // eslint-disable-next-line no-nested-ternary
    const messageType = ((_l = msg.message) === null || _l === void 0 ? void 0 : _l.documentMessage)
        ? "document"
    ...
    while (contDownload < 10 && !stream) {
        try {
            ...
            stream = yield (0, baileys_1.downloadContentFromMessage)(msg.message.audioMessage ||
                ...
                ((_m = msg.message.extendedTextMessage) === null || _m === void 0 ? void 0 : _m.contextInfo.quotedMessage.imageMessage) ||
                ((_p = (_o = msg.message) === null || _o === void 0 ? void 0 : _o.buttonsMessage) === null || _p === void 0 ? void 0 : _p.imageMessage) ||
                ((_s = (_r = (_q = msg.message) === null || _q === void 0 ? void 0 : _q.templateMessage) === null || _r === void 0 ? void 0 : _r.fourRowTemplate) === null || _s === void 0 ? void 0 : _s.imageMessage) ||
                ((_v = (_u = (_t = msg.message) === null || _t === void 0 ? void 0 : _t.templateMessage) === null || _u === void 0 ? void 0 : _u.hydratedTemplate) === null || _v === void 0 ? void 0 : _v.imageMessage) ||
                ((_y = (_x = (_w = msg.message) === null || _w === void 0 ? void 0 : _w.templateMessage) === null || _x === void 0 ? void 0 : _x.hydratedFourRowTemplate) === null || _y === void 0 ? void 0 : _y.imageMessage) ||
                ((_1 = (_0 = (_z = msg.message) === null || _z === void 0 ? void 0 : _z.interactiveMessage) === null || _0 === void 0 ? void 0 : _0.header) === null || _1 === void 0 ? void 0 : _1.imageMessage), messageType);
        }
        catch (error) {
    ...
    let filename = ((_3 = (_2 = msg.message) === null || _2 === void 0 ? void 0 : _2.documentMessage) === null || _3 === void 0 ? void 0 : _3.fileName) || "";
    if (!filename) {
...
const verifyQueue = (wbot, msg, ticket, contact) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const selectedOption = ((_6 = (_5 = msg === null || msg === void 0 ? void 0 : msg.message) === null || _5 === void 0 ? void 0 : _5.buttonsResponseMessage) === null || _6 === void 0 ? void 0 : _6.selectedButtonId) ||
        ((_8 = (_7 = msg === null || msg === void 0 ? void 0 : msg.message) === null || _7 === void 0 ? void 0 : _7.listResponseMessage) === null || _8 === void 0 ? void 0 : _8.singleSelectReply.selectedRowId) ||
...
const handleMessage = (msg, wbot) => __awaiter(void 0, void 0, void 0, function* () {
    var _9, _10, _11, _12, _13, _14, _15, _16, _17;
    if (!isValidMsg(msg))
        return;
    try {
        let msgContact;
        let groupContact;
        const isGroup = (_9 = msg.key.remoteJid) === null || _9 === void 0 ? void 0 : _9.endsWith("@g.us");
        ...
        const hasMedia = ((_10 = msg.message) === null || _10 === void 0 ? void 0 : _10.audioMessage) ||
            ((_11 = msg.message) === null || _11 === void 0 ? void 0 : _11.imageMessage) ||
            ((_12 = msg.message) === null || _12 === void 0 ? void 0 : _12.videoMessage) ||
            ((_13 = msg.message) === null || _13 === void 0 ? void 0 : _13.documentMessage) ||
            msg.message.stickerMessage ||
            ((_17 = (_16 = (_15 = (_14 = msg.message) === null || _14 === void 0 ? void 0 : _14.extendedTextMessage) === null || _15 === void 0 ? void 0 : _15.contextInfo) === null || _16 === void 0 ? void 0 : _16.quotedMessage) === null || _17 === void 0 ? void 0 : _17.imageMessage);
        if (msg.key.fromMe) {
            if (/\u200e/.test(bodyMessage))
                return;
            if (!hasMedia &&
